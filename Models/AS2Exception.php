...
class AS2Exception extends \Exception
{
     ...
     * @var array
     */
    protected static $level_failure
        = [
     ...
     * @var array
     */
    protected static $level_warning
        = [
            201 => 'duplicate-document',
            // an identical message already exists at the destination server
            202 => 'sender-equals-receiver',
    ...
    {
        if ($previous)
            parent::__construct("As2Gateway " . $message, $code, $previous);
        else
            parent::__construct("As2Gateway " . $message, $code);
    }
    ...
    {
        if (in_array($this->code, array_keys(self::$level_error)))
            return self::STATUS_ERROR;
        if (in_array($this->code, array_keys(self::$level_failure)))
            return self::STATUS_FAILURE;
        if (in_array($this->code, array_keys(self::$level_warning)))
